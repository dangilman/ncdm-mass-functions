...
# Code by Jens Stuecker, with small additions by Daniel Gilman
...
def dlogT_dlogk(beta, gamma=5.0):
    """
    Returns the absolute value of the log-derivative of the transfer function at k_1/2
    """
    fabg = (-1.0 + 0.5**(-1/gamma))
    return abs(fabg * beta * gamma / (1 + fabg))
